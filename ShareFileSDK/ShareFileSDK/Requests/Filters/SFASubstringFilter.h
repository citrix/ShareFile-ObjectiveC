...
/**
 * SFAStartsWithFilter is an SFAEqualToFilter with 'substringof' function.
 */
@interface SFASubstringFilter : SFAEqualToFilter
/**
 *  Initializes SFASubstringFilter with provided paramters
 *
 ...
 *
 *  @return Initialized SFASubstringFilter object.
 */
