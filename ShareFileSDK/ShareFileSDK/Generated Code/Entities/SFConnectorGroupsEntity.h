...
@class SFConnectorGroupZone;
@class SFConnectorGroupAccessControl;
@class SFStorageCenter;

@interface SFConnectorGroupsEntity : SFODataEntityBase
{
}
- (SFApiQuery *)get;
