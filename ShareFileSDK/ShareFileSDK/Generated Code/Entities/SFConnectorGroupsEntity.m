...
@implementation SFConnectorGroupsEntity
- (SFApiQuery *)get {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroup class];
...
- (SFApiQuery *)getZonesWithUrl:(NSURL *)url andId:(NSString *)Id {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroupZone class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)getAccessControlsWithParentUrl:(NSURL *)parentUrl andId:(NSString *)Id {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroupAccessControl class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)createWithConnectorGroup:(SFConnectorGroup *)connectorGroup {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroup class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)createZonesWithUrl:(NSURL *)url andConnectorGroupZone:(SFConnectorGroupZone *)connectorGroupZone {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroupZone class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)createAccessControlsWithUrl:(NSURL *)url andConnectorGroupAcl:(SFConnectorGroupAccessControl *)connectorGroupAcl {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroupAccessControl class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)updateZonesWithUrl:(NSURL *)url zoneId:(NSString *)zoneId andConnectorGroupZone:(SFConnectorGroupZone *)connectorGroupZone {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFConnectorGroupZone class];
    sfApiQuery.isODataFeed = NO;
...
- (SFApiQuery *)createStorageCentersWithUrl:(NSURL *)url zoneid:(NSString *)zoneid andStorageCenter:(SFStorageCenter *)storageCenter {
    SFApiQuery *sfApiQuery = [[SFApiQuery alloc] initWithClient:self.client];
    sfApiQuery.responseClass = [SFStorageCenter class];
    sfApiQuery.isODataFeed = YES;
