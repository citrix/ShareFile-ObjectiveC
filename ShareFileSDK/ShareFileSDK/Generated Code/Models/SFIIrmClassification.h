...
@class SFIIrmPrimaryAccessRightParams;

@interface SFIIrmClassification : SFIODataObject
{
...
*/
@property (nonatomic, strong) SFIIrmPrimaryAccessRightParams *PrimaryAccessRightParams;
/**
